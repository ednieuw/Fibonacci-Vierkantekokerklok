...
char VERSION[] = "FibonacciKlok_V023";         // Version of this coding
...
// while (!Serial);                                                 // Wait for serial port to connect. Needed for native USB port only
 ...
 Tekstprintln("Rotary encoder");  
                          ...
                          #endif ROTARYMOD
                          #ifdef KEYPAD3x1
// keypad.addEventListener(keypadEvent);                                  // Start the 3x4 keypad
...
void EverySecondCheck(void)
{
 ...
 if ( ms >20 && Dpin) {Dpin = LOW; digitalWrite(secondsPin,LOW);}  // Turn OFF the second on pin 13 
 ...
 if (encoderPos==0)
  {
    ...
    if(++NoofRotaryPressed >13 ) NoofRotaryPressed = 0;
    switch (NoofRotaryPressed)                                      // No of times the rotary is pressed
      {
       ...
       case 8:  Mem.DisplayPalette = 0;                break;
       case 9 ... 12:                                  break; 
       case 13: NoofRotaryPressed = 0;   Reset();      break;                     
